...
public class Det{
    ...
    public static String sumDet3(double[] nums) {
    ...
    public static String det4(String[] nums) {
    ...
    public static String det4(double[] nums) {
        return "\\(\\begin{vmatrix} " + nums[0] + " & " + nums[1] + " & " + nums[2] + " & " + nums[3] +" \\\\ " + nums[1] + " & " + nums[4] + " & " + nums[5] + " & " + nums[6] + " \\\\ " + nums[2] + " & " + nums[5] + " & " + nums[7] + " & " + nums[8] + " \\\\ " + nums[3] + " & " + nums[6] + " & " + nums[8] + " & " + nums[9] + " \\end{vmatrix} \\)";
    }

    public static void myDets(ModelMap model, double[] numbers){
